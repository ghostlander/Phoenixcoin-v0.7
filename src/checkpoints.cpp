...
static const CCheckpointData data = {
    &mapCheckpoints,
    1550039975  /* UNIX timestamp of last checkpoint block */
};

static MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of
    (1, uint256("Testnet hash of first block"));

static const CCheckpointData dataTestnet = {
    &mapCheckpointsTestnet,
    0           /* UNIX timestamp of last Testnet checkpoint block */
};
...
bool CheckBlock(int nHeight, const uint256 &hash) {
    MapCheckpoints &checkpoints = (fTestNet ? mapCheckpointsTestnet :
            mapCheckpoints);
